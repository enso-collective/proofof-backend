    ...
    const validateBrandQuery = await openai.chat.completions.create({
        ...
        messages: [{ 
            ...
            content: [ 
                ...
                - LUKSO has pink or red products.
                - SheFi brand has a logo that says SheFi and has products such as blue bucket hats, beanies, and shirts.
                - Gnosis
                - Safe{Con}
                - Olas
                - TheBuildersDAO
                ...
                Think step by step. If the answer to one or both questions is FALSE, then the claim is NOT VALID. If the answer to both questions is TRUE, then the claim is VALID.
