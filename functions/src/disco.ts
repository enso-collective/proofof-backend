// export const issueDiscoCredential = functions.https.onRequest(
//   async (req, res) => {
//     try {
...
//           throw new Error(
//             `User with email '${supportedParams.email}' could not be found`,
//           );
...
//         headers.append(
//           'Authorization',
//           `Bearer ${process.env.DISCO_ORG_API_KEY}`,
//         );
//         // Construct body
...
//           eventDescription:
//             'You met up with us at DevConnect in Istanbul, Turkey!',
...
// export const retrieveDiscoCredential = functions.https.onRequest(
//   async (req, res) => {
//     try {
//       // 1. Validate required inputs
//       const supportedParams = {
...
//           throw new Error(
//             `VC with id ${supportedParams.vcId} could not be found`,
//           );
...
// export const verifyDiscoCredential = functions.https.onRequest(
//   async (req, res) => {
//     try {
//       // 1. Validate required inputs
//       const supportedParams = {
...
// );
// const response = await fetch(
//   `https://api.disco.xyz/v1/credential/verify`,
//   {
//     method: 'POST',
//     headers,
